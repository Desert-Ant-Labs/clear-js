...
export class BluesteinFFT {
  ...
  private readonly Bf_Re: Float64Array;
  private readonly Bf_Im: Float64Array;
  private readonly Bi_Re: Float64Array;
  private readonly Bi_Im: Float64Array;
  private readonly _sRe: Float64Array;
  private readonly _sIm: Float64Array;
  ...
  /**
   * Out-of-place DFT of length N. `outRe`/`outIm` must each have length ≥ N.
   * `inverse` selects forward (false) or inverse (true); neither applies 1/N.
   */
  transform(
    xRe: Float64Array,
    xIm: Float64Array,
...
function fftRadix2Inplace(re: Float64Array, im: Float64Array, M: number, inverse: boolean): void {
